...
This app helps you to get the **Plots** of your data

**App built in Streamlit by Rouhina Dey**
''')
...
if user_file is not None:
	...
	if st.button("Click here to see Scatter Plots"):  
		...
		for k in cols_2:
			...
			#st.write(x1)
			for j in x1:
					sns.scatterplot(x=modified[k],y=modified[j])
					st.pyplot()
	...
	if st.button('See the Plots of Boston Housing Dataset'):
